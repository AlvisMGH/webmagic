 ...
 */
@Slf4j
public class TbProdProcessor implements PageProcessor, BaseProcessor {
     ...
     * @return
     */
    public static TbProdProcessor init(String keyWord) {
     ...
     * @return
     */
    public static TbProdProcessor init(String keyWord, long size) {
        TbProdProcessor processor = new TbProdProcessor();
